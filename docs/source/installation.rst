...
This package works with Python 3.10+ in Linux and Mac. You can install the latest stable version of this library from `PyPI <https://pypi.org/project/bdi-kit/>`__:
